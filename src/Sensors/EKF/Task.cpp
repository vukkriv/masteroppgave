...
struct Task: public DUNE::Tasks::Task
{
		...
		DUNE::Tasks::Task(name, ctx)
	{
		...
		param("Reinitialize EKF", m_args.reinit_ekf)
		.defaultValue("false")
		.visibility(Tasks::Parameter::VISIBILITY_USER)
		.description("If diverging EKF, reinitialize ekf.");
	...
	updateKalman(const IMC::BeaconDistance* msg)
	{
		...
		if (m_X.element(0) > 200000 || m_X.element(1) > 200000 || m_X.element(2) > 200000)
		{
