...
namespace Simulators
{
  namespace Multicopter
  {
    ...
    MulticopterModel::computeC(const Math::Matrix& nu)
    {
      ...
      // CG == CO
      Matrix nu2 = nu.get(3,5,0,0);
      Matrix C11 = m_mass * skew(nu2);
      Matrix C22 = - skew(m_inertia * nu2);

      return C11.blkDiag(C22);
