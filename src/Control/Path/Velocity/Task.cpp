      ...
      struct Task: public DUNE::Control::PathController
      {
        ...
        step(const IMC::EstimatedState& state, const TrackingState& ts)
        {
          ...
          */
          ...
          //dispatch desired heading as current velocity direction
          m_heading.value = ts.track_bearing;//ts.course;
          m_heading.setSourceEntity(getEntityId());
          dispatch(m_heading);
          spew("Sent heading data.");
        }
      };
    }
  }
